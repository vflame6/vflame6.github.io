...
**TL;DR:** leaker has received a big update since its initial release - 9 sources, 5 search types, JSONL output, and more. Check it out on GitHub - [https://github.com/vflame6/leaker](https://github.com/vflame6/leaker).
